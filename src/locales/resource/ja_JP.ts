const dict: { [key: string]: string } = {
  resetTip: 'リセット',
  resetConfirm: '解禁済みのオペレーターも含め、このモードでの全ての推測結果はリセットされる、本当にリセットしますか？',
  resetSuccess: 'リセット完了！',
  paradoxMode: '逆理演算！',
  ...
  paradoxHelpDesc: '逆理演算ではシステムから自動的に推測したオペレーター<strong style="color:rgb(255, 204, 76)">と違う</strong>結果を選出され、よく考えてシステムを降参させよう！',
  roleWinTimes: '累計成功回数：',
  minWinTimes: '最少推測回数：',
