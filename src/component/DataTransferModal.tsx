...
const DataTransferModal = () => {
  ...
  const getModeStats = (
    data?: Record<
      string,
      { playTimes?: number; winTimes?: number; roles?: Record<string, unknown> }
    >,
  ) => {
      ...
      >
        <button
          ...
          style={{
            flex: 1,
            borderBottom:
              activeTab === 'generate' ? '2px solid currentColor' : '2px solid transparent',
            borderRadius: 0,
        ...
        <button
          ...
          style={{
            flex: 1,
            borderBottom:
              activeTab === 'import' ? '2px solid currentColor' : '2px solid transparent',
            borderRadius: 0,
